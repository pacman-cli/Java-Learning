...
import com.pacman.uberreviewservice.adapter.BookingAdapter;
...
public class BookingControllers {
    ...
    public BookingControllers(BookingRepository bookingRepository, BookingAdapter bookingAdapter) {
    ...
    public ResponseEntity<List<Booking>> getAllBookings() {
        ...
        List<BookingDto> bookingDtos = bookings.stream()
                .map(bookingAdapter::toBookingDto)
                .toList();
//                .collect(Collectors.toList()); instead of this
