package com.puspo.scalablekafkaapp.videoshare.controller;

import com.puspo.scalablekafkaapp.videoshare.model.Image;
import com.puspo.scalablekafkaapp.videoshare.service.ImageService;
...
//    @Operation(summary = "Upload an image", description = "Upload an image file to Cloudinary and save details in " +
//            "MySQL")
//    @PostMapping("/upload")
//    public ResponseEntity<Image> uploadImage(
//            @RequestParam("file") MultipartFile file
...
//    @PostMapping(value = "/upload", consumes = "multipart/form-data") //sets choose file button to work.)
//    @Operation(summary = "Upload multiple images", description = "Upload multiple image files to Cloudinary")
//    public ResponseEntity<List<Image>> uploadMultipleImages(
//            @Parameter(description = "upload multiple images", required = true) @RequestParam("files") List<MultipartFile> files
//    ) throws IOException{
